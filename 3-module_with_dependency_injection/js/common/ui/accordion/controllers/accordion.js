define([
    ...
    function ($) {
        ...
        /**
         * @ngdoc object
         * @name accordion.controller:accordion
         * @description
         * Controller for the accordion directive
         */
        return ['$scope', '$attrs', 'accordionConfig',
            function($scope, $attrs, accordionConfig) {

                /**
                 * @ngdoc property
                 * @name _accordionCtrl
                 * @propertyOf accordion.controller:accordion
                 ...
                 * @ngdoc method
                 * @name closeOthers
                 * @methodOf accordion.controller:accordion
                 * @description
                 ...
                 * @eventOf accordion.controller:accordion
                 * @description
